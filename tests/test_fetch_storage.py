...
def test_fetch_storage_success(setup_database, test_client):
    ...
    # APIを呼び出し
    response = test_client.get(f"/api/fetch_storage?id_list={','.join(test_ids)}")
...
def test_fetch_storage_empty_id_list(setup_database, test_client):
    ...
    response = test_client.get("/api/fetch_storage?id_list=")
...
def test_fetch_storage_missing_id_list(setup_database, test_client):
    ...
    response = test_client.get("/api/fetch_storage")
...
def test_fetch_storage_invalid_ids(setup_database, test_client):
    ...
    response = test_client.get("/api/fetch_storage?id_list=invalid_id_1,invalid_id_2")
...
def test_fetch_storage_single_id(setup_database, test_client):
    ...
    response = test_client.get("/api/fetch_storage?id_list=single_test_id")
...
def test_fetch_storage_with_spaces(setup_database, test_client):
    ...
    response = test_client.get("/api/fetch_storage?id_list= id1 , id2 , id3 ")
